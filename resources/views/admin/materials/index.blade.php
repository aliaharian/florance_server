                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-solid">
                        <div class="box-header with-border">
                            <h3 class="box-title">افزودن متریال</h3>
                        ...
                        <div class="box-body no-padding">
                            <form role="form" action="{{route('materials.store')}}" method="POST">
                                @csrf
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">نام متریال</label>
                                        <input type="text" class="form-control" required id="material_name"
                                ...
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <select id="materialType" name="materialType" class="form-control">
                                            <option value="cabin">کابین</option>
                                            <option value="surface">صفحه</option>
                                            <option value="bowl">کاسه</option>
                                            <option value="mirror">آینه</option>
                                            <option value="drawer">کشو</option>
                                        </select>
                                    </div>
                                </div>
                                <!-- /.box-body -->
