                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-solid">
                        ...
                        <div class="box-body no-padding">
                            <form role="form" action="{{route('colors.update',['color'=>$selectedcolor->id])}}"
                                  method="POST">
                                @csrf
                                @method('put')
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" required id="color_name"
                                               value="{{$selectedcolor->name}}" name="color_name" placeholder="نام رنگ">
                                    </div>
                                </div>
                                <!-- /.box-body -->
                                    ...
                                    @foreach($colors as $color)
                                        <tr>
                                            ...
                                            <td class="mailbox-subject"><a
                                                    href="{{route('colors.edit',['color' => $color->id])}}"
