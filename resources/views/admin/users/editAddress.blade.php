...
<head>
    <title>
        ویرایش آدرس برای {{$user->name}} {{$user->last_name}}
    </title>
...
<!-- Content Wrapper. Contains page content -->
    <div class="content-wrapper">
        ...
        <form
            action="@if($admin){{route('userAddresses.update',['user' => $user->id  ,'address'=>$address->id])}}@else{{route('addresses.update',['address'=>$address->id])}} @endif"
                        ...
                        <div class="box box-primary">
                            ...
                            <div class="box-body row">
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <input value="{{$address->name}}" class="form-control" name="name" id="name"
                                           placeholder="نام تحویل گیرنده">
                                </div>
                                <div class="form-group col-sm-6">
                                    <label for="last_name">نام خانوادگی</label>
                                    <input value="{{$address->last_name}}" class="form-control" name="last_name"
                                           id="last_name"
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <select class="form-control" name="province" id="province">
                                        ...
                                        @foreach($provinces as $province)
                                            <option @if ($address->province_id == $province->id) selected
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <input value="{{$address->phone}}" class="form-control" name="phone" id="phone"
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <input value="{{$json->postalCode}}" class="form-control" name="postalCode"
                                           id="postalCode"
                                           placeholder="کد پستی">
                                </div>
                                ...
                                <div class="form-group col-sm-12">
                                    ...
                                    <textarea id="ckeditor" name="address" class="form-control"
                                              style="height: 300px">{!! $address->address !!}</textarea>
                                </div>
...
<script>
    $(document).ready(function () {
        $.ajax({
            url: `/getCities/{{$address->province_id}}/{{$address->city_id}}`, success: function (result) {
                $("#city").html(result);
            }
        });
    })
